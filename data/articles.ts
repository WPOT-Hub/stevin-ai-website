...
export const articles: Article[] = [
  ...
  },
  {
    ...
    dek: 'Google lanceert een 24/7 AI-agent die permanent op de achtergrond draait, ook als je telefoon op slot staat. Voor marketeers verdwijnt het intent-signaal dat adverteren stuurbaar maakte.',
    publishedAt: '2026-05-20',
    readMinutes: 2,
    author: { name: 'Stevin Journal', role: 'Redactie' },
    posterStyle: 'gradient' as const,
