...
export const glossary: GlossaryTerm[] = [
  ...
  },
  {
    ...
    category: 'platforms',
    shortDefinition:
      'Performance Max (PMax) is Google\'s geautomatiseerde campagne-type dat advertenties laat draaien over Search, Display, YouTube, Gmail, Discover en Maps, gestuurd door één bidding-doel.',
    fullDefinition:
  ...
  },
  {
    ...
    stevinView:
      'ROAS is fine voor dagelijkse optimalisatie en bid-strategieën, slecht voor budget-allocatie. Wij rapporteren altijd zowel platform-ROAS als profit-ROAS (op marge), en draaien een uplift-test om te zien wat van die ROAS echt incrementeel is. De gap tussen die drie cijfers (platform / profit / uplift) is vaak een factor 2-3, en in die gap zitten de echte business-besluiten.',
