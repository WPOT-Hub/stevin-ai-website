...
>
> Externen (freelancers en externe leveranciers) staan in deze lijst als categorie. De actuele lijst van betrokken externen wordt per klant bijgehouden en bij inschakeling gemeld.
...
| **OpenAI** | OpenAI LLC, limited liability company, gevestigd in San Francisco, California, VS | AI-inference (GPT-modellen): idem Anthropic; geen training op klantdata | Potentieel alle categorieën | SCCs (EU 2021/914) en OpenAI DPA; geen training op klantdata | Alle modules (AI-functies) |
...
| **Externen (freelancers en externe leveranciers)** | Wisselend per extern: rechtsvorm en land per opdracht bepaald | Uitvoering van opdrachten die vallen onder module 2 of module 3, voor klanten waarbij Stevin een extern inschakelt; de extern handelt conform de bevoegdheidsmatrix en de overeenkomst voor freelancers en externe leveranciers van Stevin | Per opdracht bepaald: gelijk aan de gegevenscategorieën die de extern nodig heeft voor zijn of haar taak | Per extern: binnen EER of SCCs plus overeenkomst externen | Module 2 en 3, uitsluitend bij klanten waarbij een extern is ingeschakeld |
...
> **Voor de jurist:** verifieer dat de DPA-addenda met Anthropic, OpenAI en Mistral daadwerkelijk zijn ondertekend en actueel zijn. Artikel A8 van de Algemene Voorwaarden belooft dit aan klanten. Als de addenda er niet zijn, moet die belofte worden aangepast of de addenda moeten worden ondertekend.
