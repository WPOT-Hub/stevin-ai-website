    ...
    <main>
      ...
      <section className="relative bg-primary pt-32 pb-20 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-6 sm:px-8 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
            Scan de markt.<br />
            <span className="text-neon">Boek slimmer.</span>
          </h1>
      ...
      <section className="py-20 bg-white">
        <div className="mx-auto max-w-7xl px-6 sm:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-primary mb-4">Van booking tot after-movie</h2>
      ...
      <section className="py-20 bg-primary">
        <div className="mx-auto max-w-7xl px-6 sm:px-8 text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">Klaar om slimmer te boeken?</h2>
          <p className="text-lg text-white/50 max-w-xl mx-auto mb-8">
            Plan een gesprek en ontdek hoe Stevin je helpt de juiste events op het juiste moment te plannen.
          </p>
          <Link href="/contact" className="inline-flex px-8 py-3.5 text-sm font-semibold bg-neon text-primary rounded-xl hover:bg-neon-dark transition-colors neon-glow">
            Plan een gesprek
          </Link>
