...
export async function GET() {
  ...
  const body = lines(
    ...
    '',
    '## Integraties',
    '- [Integraties-overzicht](https://stevin.ai/integraties): 245+ marketing-tools, 22 categorieën',
    '',
    '## Optional',
