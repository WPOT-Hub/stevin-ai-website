...
export async function GET() {
  ...
  const body = lines(
    ...
    '',
    '## Volledige context in een bestand',
    '- [llms-full.txt](https://stevin.ai/llms-full.txt): dezelfde site, maar uitgeschreven. Wat we doen, wat het kost, hoe we werken, het woordenboek en de tool-vergelijkingen voluit.',
    '',
    '## Citatie-voorkeuren',
