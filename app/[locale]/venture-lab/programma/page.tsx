    ...
    <main>
      ...
      <section className="hero-mesh-gradient -mt-[72px]" style={{ padding: 'calc(96px + 56px) 24px 96px' }}>
        <div className="mx-auto max-w-[1120px]">
          ...
          <h1
            ...
            style={{ fontSize: 'clamp(34px, 4.6vw, 64px)', maxWidth: '18ch' }}
          >
            {c.h1}
          </h1>
      ...
      <section className="bg-white" style={{ padding: '96px 24px' }}>
        <div className="mx-auto max-w-[1120px] grid grid-cols-1 lg:grid-cols-2 gap-16">
          <div>
            <h2 className="font-display font-extrabold text-primary tracking-[-0.025em] mb-5" style={{ fontSize: 'clamp(26px, 3vw, 38px)' }}>
              {c.werkwijzeH}
            </h2>
            <p className="text-[17px] text-muted leading-[1.7]">{c.werkwijze}</p>
          </div>
          <div>
            <h2 className="font-display font-extrabold text-primary tracking-[-0.025em] mb-6" style={{ fontSize: 'clamp(26px, 3vw, 38px)' }}>
              {c.selectieH}
            </h2>
