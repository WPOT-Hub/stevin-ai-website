    ...
    <main>
        ...
        <div className="mx-auto max-w-[1200px]">
          <div className="grid grid-cols-1 lg:grid-cols-[0.85fr_1fr] gap-12 lg:gap-20">
            <div>
              ...
              <h2 className="font-display font-extrabold text-primary leading-[1.08] tracking-[-0.025em]" style={{ fontWeight: 800, fontSize: 'clamp(30px, 3.4vw, 48px)' }}>
                {c.waaromH2}
              </h2>
            </div>
      ...
      <section className="bg-white" style={{ padding: '96px 24px' }}>
        <div className="mx-auto max-w-[1200px]">
          ...
          <h2 className="font-display font-extrabold text-primary leading-[1.1] tracking-[-0.025em] mb-4" style={{ fontWeight: 800, fontSize: 'clamp(30px, 3.4vw, 48px)', maxWidth: '20ch' }}>
            {c.bouwenH2}
          </h2>
      ...
      <section id="programma" className="bg-surface scroll-mt-24" style={{ padding: '96px 24px' }}>
        <div className="mx-auto max-w-[1200px]">
          ...
          <h2 className="font-display font-extrabold text-primary leading-[1.1] tracking-[-0.025em] mb-16" style={{ fontWeight: 800, fontSize: 'clamp(30px, 3.4vw, 48px)' }}>
            {c.hoeH2}
          </h2>
        ...
        <div className="mx-auto max-w-[1200px]">
          <div className="grid grid-cols-1 lg:grid-cols-[0.9fr_1fr] gap-12 lg:gap-20 items-center">
            <div>
              ...
              <h2 className="font-display font-extrabold text-white leading-[1.08] tracking-[-0.025em]" style={{ fontWeight: 800, fontSize: 'clamp(30px, 3.4vw, 48px)', maxWidth: '16ch' }}>
                {c.stevinH2}
              </h2>
            </div>
      ...
      <section id="interesse" className="bg-surface scroll-mt-24" style={{ padding: '110px 24px' }}>
        <div className="mx-auto max-w-[760px]">
          <div className="text-center mb-12">
            <h2 className="font-display font-extrabold text-primary leading-[1.1] tracking-[-0.025em] mb-5" style={{ fontWeight: 800, fontSize: 'clamp(30px, 3.4vw, 48px)' }}>
              {c.ctaH2}
            </h2>
