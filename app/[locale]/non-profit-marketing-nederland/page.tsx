...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Niet veel. Een werkende GA4-meting, één of twee actieve advertentie-accounts en een e-mail-tool zijn al genoeg om binnen twee weken zinvolle signalen te krijgen. Stevin leert wat normaal is voor jullie organisatie en signaleert pas als iets afwijkt.',
  },
  {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-muted">
                ...
                <li>• Eénmans-stichtingen zonder team</li>
