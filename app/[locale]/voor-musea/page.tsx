...
const featureIcons = [
  ...
  <Ticket key="2" className="w-5 h-5 text-accent" />,
  <GitMerge key="3" className="w-5 h-5 text-accent" />,
  <CalendarClock key="4" className="w-5 h-5 text-accent" />,
  <Mail key="5" className="w-5 h-5 text-accent" />,
...
export default async function MuseaPage({ params }: Props) {
  ...
  const t = await getTranslations('musea')
