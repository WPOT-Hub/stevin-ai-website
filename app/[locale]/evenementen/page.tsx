...
const COPY: Record<'nl' | 'en', VoorWieCopy> = {
  nl: {
    ...
    kost_h2: 'Een tournee draait elke week hetzelfde mediaplan, terwijl de koper elke week iets anders nodig heeft.',
  ...
  en: {
    ...
    kost_h2: 'A tour runs the same media plan every week, while the buyer needs something different every week.',
