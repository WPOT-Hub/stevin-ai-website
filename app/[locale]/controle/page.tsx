...
const COPY = {
  ...
  en: {
    ...
    points: [
      ...
      { t: 'Clear pricing', c: 'Outsourcing starts at 1,399 per month, running it yourself with Stevin costs 399. Which route fits follows from the diagnosis, and you can switch later. You know upfront what you get and what it costs.' },
    ...
    <>
      ...
      <section className="bg-primary" style={{ padding: '96px 24px 112px' }}>
        <div className="mx-auto max-w-[1200px] flex items-end justify-between gap-12 flex-col lg:flex-row">
          <h2 className="font-display font-extrabold text-white m-0" style={{ fontWeight: 800, fontSize: 'clamp(30px, 3.4vw, 48px)', lineHeight: '1.08', letterSpacing: '-0.03em', maxWidth: '16ch' }}>
            {c.closing_l1}
          </h2>
