...
const COPY = {
  nl: {
    ...
    hero_sub_1: 'Leef je van de telefoon, dan meten we de telefoontjes. Verkoop je via de winkel, dan kijken we naar je merk en naar wat je concurrenten doen. Daarna draaien we je campagnes, of we begeleiden je eigen mensen. En ',
  ...
  en: {
    ...
    hero_sub_1: 'If you live off the phone, we measure the calls. If you sell through shops, we look at your brand and at what your competitors are doing. After that we run your campaigns, or we coach your own people. And ',
