...
import { Star, MessageCircle, Inbox, Gauge, Wrench, Sprout } from 'lucide-react'
...
const featureIcons = [
  <Star key="1" className="w-5 h-5 text-accent" />,
  <MessageCircle key="2" className="w-5 h-5 text-accent" />,
  <Inbox key="3" className="w-5 h-5 text-accent" />,
  <Gauge key="4" className="w-5 h-5 text-accent" />,
  <Wrench key="5" className="w-5 h-5 text-accent" />,
  <Sprout key="6" className="w-5 h-5 text-accent" />,
]
...
export default async function WebsitesPage({ params }: Props) {
  ...
  const audiences = [
    { title: t('aud1_title'), desc: t('aud1_desc') },
    { title: t('aud2_title'), desc: t('aud2_desc') },
    { title: t('aud3_title'), desc: t('aud3_desc') },
  ]
