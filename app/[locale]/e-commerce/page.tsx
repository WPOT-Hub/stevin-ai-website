...
const featureIcons = [
  <Server key="1" className="w-5 h-5 text-accent" />,
  <Plug key="2" className="w-5 h-5 text-accent" />,
  <Database key="3" className="w-5 h-5 text-accent" />,
  <Users key="4" className="w-5 h-5 text-accent" />,
  <Bell key="5" className="w-5 h-5 text-accent" />,
  <FileText key="6" className="w-5 h-5 text-accent" />,
]
