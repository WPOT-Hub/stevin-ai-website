...
export const metadata: Metadata = {
  title: 'Non-profit marketing voor VZW\'s en stichtingen | Stevin',
  description:
    'Stevin koppelt jullie marketing-data en signaleert wat werkt, wat fades en waar donateurs vandaan komen. Voor VZW\'s, IVZW\'s, stichtingen, musea en goede doelen in Vlaanderen.',
  alternates: { canonical: 'https://stevin.ai/non-profit-marketing-belgie' },
}
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Ja. Stevin werkt naast Google Ad Grants ook met Meta, TikTok, e-mail-tools, donatieplatformen, ticketing-systemen en jullie eigen website-data. Voor organisaties die geen Grant hebben, is dit een manier om uit beperkt eigen budget meer te halen.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Alle data blijft binnen de EU. Stevin draait op Europese servers en verwerkt persoonsgegevens niet. Donor-data wordt geanonimiseerd bij ingest. AI-verwerking via Mistral en Anthropic, geen overdracht buiten de EU.',
  },
  {
    question: 'Wat kost dit voor een non-profit?',
    answer:
...
export default async function NonProfitBelgiePage({ params }: Props) {
      ...
      <section className="bg-primary -mt-[72px]" style={{ padding: 'calc(96px + 72px) 24px 96px' }}>
        <div className="mx-auto max-w-[1200px]">
          <p className="text-[#5DA3FF] text-[13px] font-display font-bold tracking-[0.08em] uppercase mb-8 flex items-center gap-[14px]">
            ...
            NON-PROFIT MARKETING · VLAANDEREN
          </p>
          ...
          <p className="text-white/40 text-sm mt-8">
            Voor VZW&apos;s, IVZW&apos;s, stichtingen, musea, gezondheidsfondsen, culturele instellingen en goede doelen.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-2 text-muted">
                <li>• VZW&apos;s en IVZW&apos;s met actieve fondswerving</li>
                <li>• Private stichtingen en stichtingen van openbaar nut</li>
                <li>• Musea en culturele instellingen</li>
                <li>• Gezondheidsfondsen</li>
                <li>• Goede doelen met campagne-pieken (oktober, kerst)</li>
                <li>• Lokale maatschappelijke organisaties met groei-ambitie</li>
              </ul>
            </div>
            <div>
